                ...
                <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-3xl">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="photo" value={formData.photo} onChange={handleChange} className="input-field" />
                        </div>
                        <div>
                    ...
                    <div className="mt-6 flex justify-end space-x-4">
                        <button className="bg-gray-500 hover:bg-gray-600 text-white font-medium py-2 px-6 rounded-lg" onClick={() => navigate("/users")}>
                            Cancel
                        </button>
                        <button className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-6 rounded-lg" onClick={handleUpdate}>
                            Update
                        </button>
                    </div>
                </div>
